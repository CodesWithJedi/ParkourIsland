...
pygame.display.set_caption('Parkour Island! By JediCubing')
...
game_over_fx = pygame.mixer.Sound('DEATH.wav')
...
class Player():
	...
	def update(self, game_over):
		...
		if game_over == 0:
			...
			draw_text('GAME OVER!', font, Dark_Cyan, (screen_width // 2) - 200, screen_height // 2)
			if self.rect.y > 200:
				self.rect.y -= 5
	...
	if main_menu == True:
		...
		if game_over == 0:
			...
			if pygame.sprite.spritecollide(player, coin_group, True):
				score += 1
				coin_fx.play()
			draw_text('X ' + str(score), font_score, Dark_Cyan, tile_size - 10, 10)
		...
		if game_over == 1:
			...
			if level <= max_levels:
				...
				draw_text('YOU WIN!', font, Dark_Cyan, (screen_width // 2) - 140, screen_height // 2)
